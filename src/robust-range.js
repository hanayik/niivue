...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_robust_range')) {
        Object.defineProperty(Module['ready'], '_robust_range', { configurable: true, get: function() { abort('You are getting _robust_range on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_robust_range', { configurable: true, set: function() { abort('You are setting _robust_range on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'robust-range.wasm';
...
/** @type {function(...*):?} */
var _robust_range = Module["_robust_range"] = createExportWrapper("robust_range");
